...
$url="http://192.168.0.18:80/movies/cover/";
...
// Verifica si se proporcionó un título para buscar
if (isset($_GET['titulo'])) {
    // Filtra las películas que coincidan con el título proporcionado
    $tituloBuscado = $_GET['titulo'];
    $movies = array_filter($movies, function ($movie) use ($tituloBuscado) {
        return stripos($movie['titulo'], $tituloBuscado) !== false;
    });
}
